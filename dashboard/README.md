...
| `build_artifact.py` | Builds `inventory_artifact.html` — fonts and logo inlined, wrapper stripped — for publishing as an Artifact. Output is gitignored. |
...
- **Hero products** — products ranked by units sold over a **chosen date
  ...
  different fact from carrying it and having sold out. Days left uses the
  60-day rate, steadier than the 7-day one for products selling this
  consistently.
